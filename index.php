...
<html lang="en">
  ...
  <body class="utama">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark fixed" data-bs-theme="dark">
    ...
    <!-- Carousel -->
    <div id="carousel" class="container img-fluid pt-2">
      ...
      <div class="row text-center row-container">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
          <div class="menu-kategori">
            <a href="#"><img src="assets/kategori/nugget.png" class="img-categori mt-3" alt="nugget"></a>
            <p>nugget</p>
          </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-4 col-6">
